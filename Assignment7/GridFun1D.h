...
public:
	...
	GridFun1D(long xPanel, double xMin, double xMax,vector<double> values){
		initialize(xPanel, xMin, xMax,values);
	};
	...
	void initialize(long xPanel, double xMin, double xMax,vector<double>values) {
		this->xPanel = xPanel;
		this->xMin = xMin;
		this->xMax = xMax;
